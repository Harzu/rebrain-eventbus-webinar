...
type Client struct {
	...
	KafkaMessageCurrentOffsetNumber *messageCurrentOffsetNumber
}
...
func New() *Client {
	...
	client := &Client{
		...
		KafkaMessageCurrentOffsetNumber: newMessageCurrentOffsetNumber(),
	}

	client.EventbusMessagesProcessingTime.Register(registry)
	client.EventbusMessageCount.Register(registry)
	client.KafkaMessageCurrentOffsetNumber.Register(registry)
